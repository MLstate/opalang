...
" package BuildInfos.opa_version_name
  ...
  let compilation_generation ?package env_opt plugin_requires
  ...
  let linking_generation env_opt env_bsl plugin_requires loaded_bsl env_js_input =
    ...
    compilation_generation ~package env_opt plugin_requires loaded_bsl.bundled env_js_input
  ...
  let js_generation env_opt env_bsl loaded_bsl env_js_input =
    ...
    | `compilation ->
        compilation_generation env_opt plugin_requires
