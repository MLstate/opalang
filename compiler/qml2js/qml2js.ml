...
" package BuildInfos.opa_version_name
  ...
  let compilation_generation ?(depends=[]) ?package env_opt plugin_requires
  ...
  let linking_generation ?depends env_opt env_bsl plugin_requires loaded_bsl env_js_input =
    ...
    compilation_generation ?depends ~package env_opt plugin_requires loaded_bsl.bundled env_js_input
  ...
  let js_generation ?depends env_opt env_bsl loaded_bsl env_js_input =
    ...
    | `compilation ->
        compilation_generation ?depends env_opt plugin_requires
          loaded_bsl.bundled env_js_input
    | `init -> ()
    | `linking ->
        linking_generation ?depends env_opt env_bsl plugin_requires
