...
@private compare_int_postenv    = @nonexpansive(Magic.id(compare_char_postenv_)  : P.implementation)
...
@private compare_char   = @nonexpansive(Magic.id(@toplevel().compare_int) :'a,'a->Order.comparison)
@private compare_int    = @nonexpansive(Magic.id(@toplevel().compare_int) :'a,'a->Order.comparison)
@private compare_float  = @nonexpansive(Magic.id(@toplevel().compare_int) :'a,'a->Order.comparison)
@private compare_string = @nonexpansive(Magic.id(@toplevel().compare_int) :'a,'a->Order.comparison)
