...
##register add_int16_ler : binary, int -> opa[outcome(void,string)]
...
##register add_int16_ber : binary, int -> opa[outcome(void,string)]
...
##register add_int32_ler : binary, int -> opa[outcome(void,string)]
...
##register add_int32_ber : binary, int -> opa[outcome(void,string)]
...
##register add_int53_ler : binary, int -> opa[outcome(void,string)]
let add_int53_ler b i =
  (* if (i < -0x20000000000000 || i > 0x1fffffffffffff) then error (Printf.sprintf "BslBinary.add_int53_le: out of range int %d" i); *)
  add_uint64_le b (Int64.of_int i);
  BslUtils.create_outcome (`success ())
...
##register add_int53_ber : binary, int -> opa[outcome(void,string)]
let add_int53_ber b i =
  (* if (i < -0x20000000000000 || i > 0x1fffffffffffff) then error (Printf.sprintf "BslBinary.add_int53_be: out of range int %d" i); *)
  add_uint64_be b (Int64.of_int i);
  BslUtils.create_outcome (`success ())
...
##register add_float_ler : binary, float -> opa[outcome(void,string)]
...
##register add_float_ber : binary, float -> opa[outcome(void,string)]
...
##register get_int53_ler : binary, int -> opa[outcome(int,string)]
let get_int53_ler b p =
  BslUtils.create_outcome (`success (
    Int64.to_int (get_int64_le b p) (* will overflow *)
  ))

##register get_int53_be : binary, int -> int
let get_int53_be b p = Int64.to_int (get_int64_be b p) (* will overflow *)

##register get_int53_ber : binary, int -> opa[outcome(int,string)]
let get_int53_ber b p =
  BslUtils.create_outcome (`success (
    Int64.to_int (get_int64_be b p) (* will overflow *)
  ))

##register get_uint64_le : binary, int -> int64
let get_uint64_le b p = get_int64_le b p (* it's actually signed *)

##register get_uint64_ler : binary, int -> opa[outcome(int64,string)]
let get_uint64_ler b p =
  BslUtils.create_outcome (`success (
    get_int64_le b p (* it's actually signed *)
  ))

##register get_uint64_be : binary, int -> int64
let get_uint64_be b p = get_int64_be b p (* it's actually signed *)

##register get_uint64_ber : binary, int -> opa[outcome(int64,string)]
let get_uint64_ber b p =
  BslUtils.create_outcome (`success (
    get_int64_be b p (* it's actually signed *)
  ))
...
##register get_float_ler : binary, int -> opa[outcome(float,string)]
...
##register get_float_ber : binary, int -> opa[outcome(float,string)]
...
##register get_double_ler : binary, int -> opa[outcome(float,string)]
let get_double_ler b p =
  BslUtils.create_outcome (`success (
    Int64.float_of_bits (get_int64_le b p)
  ))

##register get_double_be : binary, int -> float
let get_double_be b p = Int64.float_of_bits (get_int64_be b p)

##register get_double_ber : binary, int -> opa[outcome(float,string)]
let get_double_ber b p =
  BslUtils.create_outcome (`success (
    Int64.float_of_bits (get_int64_be b p)
  ))
