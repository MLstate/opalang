...
1. The server prompts the client for the value of +edit_content+ (2 requests).
1. The server instructs the client to hide +show_content+ (2 requests).
1. The server instructs the client to show +edit_content+ (2 requests).
