...
install-qmlflat: # depends on opabsl_for_compiler, but we don't want to run ocamlbuild twice
	...
	@$(INSTALL) $(BUILD_DIR)/opabsl/mlstatebsl/opabsl_*.opa $(INSTALL_DIR)/share/opa/mlstatebsl
